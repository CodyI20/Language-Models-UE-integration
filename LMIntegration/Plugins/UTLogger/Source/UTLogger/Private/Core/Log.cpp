...
DEFINE_LOG_CATEGORY_STATIC(LogUTLogger, Log, All);
...
{
	UE_LOG(LogUTLogger, Error, TEXT("[%s] %s"), *Tag, *Text);
...
{
	UE_LOG(LogUTLogger, Warning, TEXT("[%s] %s"), *Tag, *Text);
...
{
	UE_LOG(LogUTLogger, Display, TEXT("[%s] %s"), *Tag, *Text);
...
{
	UE_LOG(LogUTLogger, Verbose, TEXT("[%s] %s"), *Tag, *Text);
